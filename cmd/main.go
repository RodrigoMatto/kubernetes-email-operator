...
import (
	...
	"github.com/RodrigoMatto/kubernetes-email-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(emailalertsv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c3d595d0.koperator.rmatto",
