...
//+kubebuilder:rbac:groups=email-alerts.koperator.rmatto,resources=emailsenderconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=email-alerts.koperator.rmatto,resources=emailsenderconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=email-alerts.koperator.rmatto,resources=emailsenderconfigs/finalizers,verbs=update
